...
$sql = "SELECT ID, created_at, date, time, latitude, longitude, accuracy, species, deadinjured, sex, age, name, contact_info, notes, upload_url FROM Atlanta_Audubon $query ORDER BY ID ASC";
